...
public class LemmagenAnalysisTest extends ESTokenStreamTestCase {
    ...
    public ESTestCase.TestAnalysis createAnalysis() throws IOException {
        InputStream lexicon = LemmagenAnalysisTest.class
                .getResourceAsStream("/org/elasticsearch/index/analysis/cs.lem");

        Path home = createTempDir();
        Path config = home.resolve("config").resolve(LemmagenFilterFactory.DEFAULT_DIRECTORY);
